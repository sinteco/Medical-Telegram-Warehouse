  ...
  create  table "medical_warehouse"."dwh"."fct_messages__dbt_tmp"
  ...
  (
    with stg as (
    select * from "medical_warehouse"."dwh"."stg_telegram"
),

channels as (
    select * from "medical_warehouse"."dwh"."dim_channels"
),

dates as (
    select * from "medical_warehouse"."dwh"."dim_dates"
)
